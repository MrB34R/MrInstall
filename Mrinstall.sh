...
echo -e  "Tools    : Mr.B34R_Install   $white   " |lolcat
echo -e  "Creadby  : MrB34R $white   " |lolcat
echo -e  "Contact  : Maling3121@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Mr.B34R" | lolcat
exit
;;
